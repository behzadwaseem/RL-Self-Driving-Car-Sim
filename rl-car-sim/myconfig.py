try:
    from myconfig_local import *
except ImportError:
    print("No myconfig_local.py file found")
# """ 
# My CAR CONFIG 
...
# 
# #CAMERA
CAMERA_TYPE = MY_CAMERA_TYPE   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|D435|MOCK|IMAGE_LIST)
# IMAGE_W = 160
# IMAGE_H = 120
...
DONKEY_GYM = MY_DONKEY_GYM
DONKEY_SIM_PATH = MY_DONKEY_SIM_PATH #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
DONKEY_GYM_ENV_NAME = MY_DONKEY_GYM_ENV_NAME # ("donkey-generated-track-v0"|"donkey-generated-roads-v0"|"donkey-warehouse-v0"|"donkey-avc-sparkfun-v0")
